defmodule BucketMQWeb.ProjectControllerTest do
  use BucketMQWeb.ConnCase

  alias BucketMQ.Projects

  @create_attrs %{git_repo: "some git_repo", slug: "some slug", title: "some title"}
  @update_attrs %{git_repo: "some updated git_repo", slug: "some updated slug", title: "some updated title"}
  @invalid_attrs %{git_repo: nil, slug: nil, title: nil}
  ...
  describe "update project" do
    ...
    test "redirects when data is valid", %{conn: conn, project: project} do
      ...
      assert html_response(conn, 200) =~ "some updated git_repo"
    end
